...
const FILTER_KEY = 'moebius-atlas-index-filters';
...
/**
 * Flat index: every tagged topic, alphabetical. Three independent chip
 ...
 */
export function IndexList({ onOpen }: { onOpen: (id: string) => void }) {
  const lang = useLang();
  ...
  return (
    <div className="index-view">
      <div className="index-filter-head">
